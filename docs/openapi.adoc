...
image::images/swagger.png[swagger,600]
...
image::images/swaggeryeartestresult.png[swaggeryeartestresult,600]
...
image::images/swaggerparams.png[swaggerparams,600]
